package ru.promo.homework.BibaevRuslan;
...
public class BibaevRuslanMap<K, V> implements Map<K, V> {
    ...
    public BibaevRuslanMap() {
        this(DEFAULT_INITIAL_CAPACITY, DEFAULT_LOAD_FACTOR);
    }

    public BibaevRuslanMap(int initialCapacity) {
        this(initialCapacity, DEFAULT_LOAD_FACTOR);
    }

    @SuppressWarnings("unchecked")
    public BibaevRuslanMap(int initialCapacity, float loadFactor) {
